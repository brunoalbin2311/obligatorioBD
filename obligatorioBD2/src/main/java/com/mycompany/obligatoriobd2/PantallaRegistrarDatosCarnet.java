 ...
 * @author albin
 */
public class PantallaRegistrarDatosCarnet extends javax.swing.JFrame {
     ...
     */
    public PantallaRegistrarDatosCarnet() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaRegistrarDatosCarnet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaRegistrarDatosCarnet().setVisible(true);
            }
        });
    }
